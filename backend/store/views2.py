...
class CheckoutView(APIView):
    ...
    def post(self, request):
        ...
        # New location data coming from React
        shipping_lat = request.data.get('shipping_latitude')
        shipping_lng = request.data.get('shipping_longitude')
        ...
        if delivery_method == 'delivery' and shipping_lat and shipping_lng:
            user.saved_lat = shipping_lat
            user.saved_lng = shipping_lng
        user.save()
        ...
        if delivery_method == 'delivery':
            shipping_fee = calculate_shipping_fee(shipping_lat, shipping_lng)
